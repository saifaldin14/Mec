...
test('Server starts and serves HTML containing "List of frameworks"', async (t) => {
  ...
  const mecPath = path.resolve(__dirname, "../packages/bin/mec.js");

  await new Promise((resolve, reject) => {
    // Spawn the process running "mec dev" from the tests/sample directory
    server = spawn("node", [mecPath, "dev"], {
